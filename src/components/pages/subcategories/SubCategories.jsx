...
const SubCategories = () => {
  ...
  const addCategory = async (e) => {
    ...
    fd.append("category", namea);
    fd.append("category", nameb);
    fd.append("featureddetails", featureddetails);
          ...
          <div className="bg-slate-100 overflow-y-auto  lg:w-3/6  md:w-4/6 w-5/6 mx-auto  rounded-lg">
            ...
            >
              ...
              <div className="inline-flex  w-full flex-col">
                ...
                <input
                  value={edit ? edit.category : namea}
              ...
              <div className="inline-flex  w-full flex-col">
                ...
                <input
                  value={edit ? edit.category : nameb}
              ...
              <div className="inline-flex  w-full flex-col">
                ...
                <ReactQuill
                  theme="snow"
                  value={edit ? edit.featureddetails : featureddetails}
