...
const Appointments = () => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            const {data} = await axios.get("https://aashish-yocket-api.herokuapp.com/api/admin/appointments/trainers/631edc81e5471552bfe42726",
                {
            ...
            >
              ...
              <div className="inline-flex  w-full flex-col">
                ...
                <input
                  ...
                  type="file"
                  placeholder=""
                  onChange={(e) => setN(e.target.files[0])}
                  className=" text-gray-800 tracking-wider text-sm rounded-full py-1 px-2 outline-[rgb(240,72,88)]"
                />
              </div>
              <div className="inline-flex  w-full flex-col">
                    ...
                    <table className="table-auto  w-full text-left whitespace-no-wrap">
                        ...
                        <tbody>

                            {
                                   ...
                                   data?.requiredAppointment?.map((e, i) => {
...
export default HOC(Appointments);
